...
global.sudo = process.env.SUDO || '212604687805'
global.devs = '212604687805';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '【⚜┇𝐈.𝐂.𝐍.𝐃 🌙 ℍ𝔸𝕐𝔸ℕ ┇⚜】' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '【⚜┇𝐈.𝐂.𝐍.𝐃 🌙 𝕄𝕀𝕂𝕌 ┇⚜】' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '【⚜┇𝐈.𝐂.𝐍.𝐃 🌙 ℍ𝔸𝕐𝔸ℕ ┇⚜】' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '【⚜┇𝐈.𝐂.𝐍.𝐃 🌙 𝕄𝕀𝕂𝕌 ┇⚜】' : process.env.PACK_INFO.split(";")[1],
