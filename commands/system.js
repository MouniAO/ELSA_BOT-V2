...
cmd({
        ...
        async(Void, citel, text, isAdmins) => {
            ...
            const alivtxt = `
*🌙⃝🧚‍♀️مـرحـبـا┇ ${citel.pushName}*
*🌙⃝🧚‍♀️انــا┇ ${tlang().title}*
${alivemessage}
*❋─═━•┇🌙┇•━═─❋*
*🌙⃝🧚‍♀️الاصـدار┇ v1*
*🌙⃝🧚‍♀️مـده الـتـشـغـيـل┇ ${runtime(process.uptime())}*
*🌙⃝🧚‍♀️الـمـطـور┇ ${Config.ownername}_
*🌙⃝🧚‍♀️الـفـرع┇ ${Config.BRANCH}*
*❋─═━•┇🌙┇•━═─❋*
*🌙⃝🧚‍♀️اكـتـب .الاوامر لـظـهـور اوامـر الـبـوت*

*🌙⃝🧚‍♀️صـنـع بـواسـطـه┇ ${Config.ownername}*
`;
            let aliveMessage = {
                image: {
                    url: await botpic(),
...
cmd({
    ...
    async(Void, citel, text,{ isCreator }) => {
        ...
        let leadtext = `*🌙⃝🧚‍♀️كـل مـلاحـظـاتـك هـنـا📝┇*\n\n`
