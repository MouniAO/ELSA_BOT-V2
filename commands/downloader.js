...
if (text.startsWith("https://youtube.com/shorts/")) {
 ...
 ╼━━━━━━➢━━━━━━━━╾
      🎧HAYAN 𝑌𝛩𝑈𝑇𝑈𝐵𝛯⃤🎧
 ╼━━━━━━➢━━━━━━━━╾
*🌙⃝🧚‍♀️الـعـنـوان🗒️┇* ${anu.title}

*🌙⃝🧚‍♀️الـمـده⏳┇* ${anu.timestamp}
*🌙⃝🧚‍♀️الـمـشـاهـدات👀┇* ${anu.views}
*🌙⃝🧚‍♀️الـنـشـر📤┇* ${anu.ago}
*🌙⃝🧚‍♀️الـقـنـاه🧑‍🎤┇* ${anu.author.name}
*🌙⃝🧚‍♀️الـفـيديـو⬇️┇*
 ╼━━━━━━➢━━━━━━━╾
*🌙⃝🧚‍♀️الـرابـط🔗┇* ${anu.url}
`,
             ...
             //   citel.reply('*Downloadig:* '+titleYt)
                ...
                if (fileSizeInMegabytes <= dlsize) {
                    let buttonMessage = {
                        ...
                        caption: `*🌙⃝🧚‍♀️الـعـنـوان🗒️┇ ${titleYt}*\n *🌙⃝🧚‍♀️حـجـم الـمـلـف📥┇ ${fileSizeInMegabytes} مـيـجـا*`,
                        headerType: 4,
                        contextInfo: {
                            externalAdReply: {
                                title: titleYt,
...
let result4 = ` *📥HAYAN� 𝛭𝛯𝐷𝛪𝛥𝐹𝛪𝑅𝛯📥*
*🌙⃝🧚‍♀️الاسـم👤┇ ${baby1[0].nama}*
*🌙⃝🧚‍♀️لـحـجـم⭕┇ ${baby1[0].size}*
*🌙⃝🧚‍♀️مـلـكـي🔰┇ ${baby1[0].mime}*
            ...
            try {
                ...
                if (fileSizeInMegabytes <= dlsize) {
                    ...
                    let buttonMessage = {
                        ...
                        mimetype: 'video/mp4',
                        fileName: `${titleYt}.mp4`,
                        caption: ` *🌙⃝🧚‍♀️لـعـنـوان🗒️┇ ${titleYt}*\n *🌙⃝🧚‍♀️حـجـم الـمـلـف📥┇ ${fileSizeInMegabytes} مـيـجـا*`,
                        headerType: 4,
                        contextInfo: {
                            externalAdReply: {
                                title: titleYt,
